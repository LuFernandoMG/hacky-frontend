...
export default function Home() {
  const data = [
    ...
    },
    {
      id: 2,
      title: "Project Beta",
      description: "A project to develop a beta version of our new product. This project focuses on testing and refining the features developed in the alpha phase. The goal is to identify and fix bugs, improve performance, and ensure the product is ready for a wider audience. This phase is essential for validating the product's functionality and usability.",
      category: {
        id: 2,
        name: "Testing",
      },
